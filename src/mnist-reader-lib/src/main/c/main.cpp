...
int main() {
    ...
    ILog4zManager::getRef().setLoggerName(LOG4Z_MAIN_LOGGER_ID, "mnist-reader-lib-log");
    ...
    */
    ...
    cout << "mnist-reader-lib: Hello world from Maven NAR Project with CLion IDE!" << endl;
    cout << "mnist-reader-lib: Now you should open the terminal set your compiler path and type: mvn test or mvn install" << endl;
    return 0;
}