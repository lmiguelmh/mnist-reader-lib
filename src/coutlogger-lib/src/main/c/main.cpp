...
int main() {
    ...
    ILog4zManager::getRef().setLoggerName(LOG4Z_MAIN_LOGGER_ID, "coutlogger-lib-log");
    ...
    */
    ...
    cout << "coutlogger-lib: Hello world from Maven NAR Project with CLion IDE!" << endl;
    cout << "coutlogger-lib: Now you should open the terminal set your compiler path and type: mvn test or mvn install" << endl;
    return 0;
}