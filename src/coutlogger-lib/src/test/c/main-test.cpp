...
int main(int argc, char **argv) {
    ...
    ILog4zManager::getRef().setLoggerName(LOG4Z_MAIN_LOGGER_ID, "coutlogger-lib-test");
    ...
    */
    ...
    cout << "coutlogger-lib-test: Hello World from Maven NAR Project Test with CLion IDE!" << endl;
    return 0;
}