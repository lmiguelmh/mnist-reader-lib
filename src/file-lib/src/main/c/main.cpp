...
int main() {
    ...
    ILog4zManager::getRef().setLoggerName(LOG4Z_MAIN_LOGGER_ID, "file-lib-log");
    ...
    */
    ...
    cout << "file-lib: Hello world from Maven NAR Project with CLion IDE!" << endl;
    cout << "file-lib: Now you should open the terminal set your compiler path and type: mvn test or mvn install" << endl;
    return 0;
}